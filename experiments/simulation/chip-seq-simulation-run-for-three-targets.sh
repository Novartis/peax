...
if [ -f "data/simulated-genome-$SUFFIX.fa" ] && [ -f "data/reads-3-targets-target-1$POST_FIX-$SUFFIX.fastq" ]  && [ -f "data/reads-3-targets-target-2$POST_FIX-$SUFFIX.fastq" ] && [ -f "data/reads-3-targets-target-3$POST_FIX-$SUFFIX.fastq" ] && [ -f "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.fastq" ] && [ "$CLEAR" != true ] ; then
  ...
  > "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.fastq"
...
bwa mem -t 2 "data/simulated-genome-$SUFFIX.fa" "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.fastq" > "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sam"
...
samtools view -bT "data/simulated-genome-$SUFFIX.fa" "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sam" > "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.bam"
...
samtools sort -O bam -T temp "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.bam" > "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam"
...
samtools index "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam"

echo "Compute signal..."
bamCompare -b1 "data/reads-3-targets-target-1$POST_FIX-$SUFFIX.sorted.bam" -b2 "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam" -o "data/fold-change-target-1$POST_FIX-$SUFFIX.bigWig"
bamCompare -b1 "data/reads-3-targets-target-2$POST_FIX-$SUFFIX.sorted.bam" -b2 "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam" -o "data/fold-change-target-2$POST_FIX-$SUFFIX.bigWig"
bamCompare -b1 "data/reads-3-targets-target-3$POST_FIX-$SUFFIX.sorted.bam" -b2 "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam" -o "data/fold-change-target-3$POST_FIX-$SUFFIX.bigWig"
...
bamCoverage -b "data/reads-3-targets-baseline$POST_FIX-$SUFFIX.sorted.bam" -o "data/signal-baseline$POST_FIX-$SUFFIX.bigWig" --binSize 25 --normalizeUsing RPGC --effectiveGenomeSize $LENGTH --extendReads 50
