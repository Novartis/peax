...
const mapStateToProps = state => ({
  searchRightBarInfoMetadata:
    state.present.searchRightBarInfoMetadata,
});

const mapDispatchToProps = dispatch => ({
  toggleSearchRightBarInfoMetadata:
    isOpen => dispatch(setSearchRightBarInfoMetadata(!isOpen)),
});
