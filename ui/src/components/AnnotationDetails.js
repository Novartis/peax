  ...
  <div className={`annotation-details ${props.className}`}>
    <div className="flex-c annotation-details-header">
      <div className="flex-c flex-g-1">
        <ToolTip delayIn={1000} delayOut={500} title="Last edited">
          <Icon iconId="calendar" />
          <div>3/4/2017</div>
        </ToolTip>
      </div>
      <ToolTip align="right" delayIn={1000} delayOut={500} title="Share">
    ...
    <div className="annotation-details-loci">
      <ol className="flex-c">
        <div className="flex-g-1 flex-c flex-v" />
        <ToolTip align="right" delayIn={1000} delayOut={500} title="Remove">
