...
const RangeSelectionViewer = props => (
  <div className='range-selection-viewer'>
    ...
    {(!props.is1d || (props.is1d && props.isX)) && (
      <div className={`flex-c range-selection-viewer-x ${props.is1d ? 'range-selection-viewer-x-only' : ''}`}>
        {!props.is1d && (
    ...
    {(!props.is1d || (props.is1d && !props.isX)) && (
      <div className={`flex-c range-selection-viewer-y ${props.is1d ? 'range-selection-viewer-y-only' : ''}`}>
        {!props.is1d && (
          <Icon iconId='arrow-right-with-body' mirrorV={true} />
        )}
        <div className='flex-c flex-g-1'>
          <strong className='axis'>Y</strong>
          <div className='flex-g-1'>
